...
from src.data.transforms import VideoCenterCrop, VideoRescale, VideoResize, VideoReOrder
from src.models.c3d import C3D
from src.data import UCF101
...
def c3d_ucf101_eval(args_opt):
    ...
    transforms = [VideoResize([128, 171]),
                  VideoRescale(shift="src/example/resized_mean_sports1m.npy"),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_path', type=str, default=".vscode/c3d_20220912.ckpt",
